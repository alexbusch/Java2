...
public class taschenrechnerr extends JFrame implements ActionListener {
    ...
    public taschenrechnerr() // mit PUBLIC werden die Rückgabewerte ausserhalb des Objekts sichtbar
    {
